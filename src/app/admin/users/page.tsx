                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="pl-11 pr-6 py-3 bg-zinc-900/50 border border-white/5 rounded-xl text-sm text-white focus:outline-none focus:border-white/20 transition-all w-full md:w-80"
                            />
                        </div>
                        <button
                            onClick={fetchUsers}
